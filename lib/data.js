...
export function getWorkspaceConfig() {
  ...
  return {
    ...
    workspace_mark: settings.workspace_mark || "TG",
    workspace_tagline: settings.workspace_tagline || "Revenue OS",
    currency: settings.currency || "USD",
    locale: settings.locale || "en-US",
    timezone: settings.timezone || "Africa/Cairo",
    date_format: settings.date_format || "%Y-%m-%d",
    default_home: settings.default_home || "/",
    compact_mode: parseBooleanSetting(settings.compact_mode, false),
    ...
    theme: normalizeThemeConfig(settings.theme_config)
  };
}
